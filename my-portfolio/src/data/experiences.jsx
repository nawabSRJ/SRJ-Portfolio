...
const experiences = [
  {
    role: "Project Intern",
    company: "Help Club - Web Veda",
    icon: <FaRocket className="text-white dark:text-black" />,
    duration: "Feb 2024 - Apr 2024",
    description: "Worked in the core team of Help Club social media platform led by entrepreneur and influencer Ankur Warikoo.",
  },
  {
